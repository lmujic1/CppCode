...
Vektor3d VektorskiProizvod(const Vektor3d &v1, const Vektor3d &v2) {
    double a(std::get<1>(v1)*std::get<2>(v2)-std::get<2>(v1)*std::get<1>(v2));
    double b(std::get<2>(v1)*std::get<0>(v2)-std::get<0>(v1)*std::get<2>(v2));
    double c(std::get<0>(v1)*std::get<1>(v2)-std::get<1>(v1)*std::get<0>(v2));
    return std::tie(a,b,c);
}
